...
export default function PeerSupport() {
  ...
  const filteredPosts =
    posts?.filter((post: ForumPostType) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Connect safely with fellow students in moderated forums. Share
              experiences and support each other anonymously.
            </p>
            ...
            <Alert className="max-w-4xl mx-auto mt-6">
              ...
              <AlertDescription>
                ...
                respectful, supportive, and kind. All posts are moderated for
                safety. Report inappropriate content using the report button.
              </AlertDescription>
            </Alert>
          </div>
                  ...
                  <Form {...form}>
                    ...
                    >
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          Posts are reviewed by moderators before being
                          published to ensure a safe environment for all users.
                        </AlertDescription>
                      </Alert>
                  ...
                  {categoriesLoading ? (
                    <div className="space-y-2">
                      {[...Array(5)].map((_, i) => (
                        <div
                          key={i}
                          className="animate-pulse bg-muted h-10 rounded"
                        ></div>
                      ))}
                    </div>
                  ) : (
