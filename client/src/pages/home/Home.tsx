...
/**
 * InnerSpring Homepage - Enhanced Mental Health Platform
 *
...
export default function Home() {
    ...
    () => [
      {
        number: "73%",
        description:
          "of students experienced a mental health crisis in the past year",
      ...
      },
      {
        number: "60%",
        description:
          "say mental health significantly impacted their academic performance",
        additional:
          "Leading to lower GPAs, course withdrawals, and delayed graduation",
        icon: TrendingDown,
        accent: "orange",
      },
      {
        number: "85%",
        description:
          "don't seek help due to stigma, cost, or lack of accessible services",
        additional:
          "Traditional counseling centers serve only 15% of students needing help",
        icon: Shield,
        accent: "purple",
      },
      {
        ...
        additional:
          "Yet campus counseling resources haven't scaled to meet demand",
        icon: AlertCircle,
        accent: "dark-red",
      },
    ],
    ...
    () => [
      {
        ...
        description:
          "Immediate coping strategies, breathing exercises, and emotional support when you need it most",
        useCase:
          "Perfect for late-night anxiety, pre-exam stress, or sudden panic",
      ...
      },
      {
        ...
        description:
          "Schedule confidential appointments with licensed campus counselors and mental health professionals",
        useCase:
          "When you need deeper support, therapy, or professional diagnosis",
      ...
      },
      {
        ...
        description:
          "Understand your mental health with validated tools used by professionals (PHQ-9, GAD-7, stress scales)",
      ...
      },
      {
        ...
        description:
          "Videos, articles, audio guides, and interactive tools for managing anxiety, depression, stress, and more",
      ...
      },
      {
        ...
        description:
          "Connect with other students facing similar challenges in moderated, safe discussion groups",
      ...
      },
      {
        ...
        description:
          "Immediate help for mental health emergencies, suicidal thoughts, or when you need help right now",
  ...
  const journeySteps = useMemo(
    () => [
      ...
      },
      {
        ...
        description:
          "Schedule with licensed counselors who understand students",
        time: "Same day",
        icon: UserCheck,
        action: "Book Session",
        href: "/appointments",
      ...
      },
      {
        ...
        description:
          "Access personalized coping strategies and self-help tools",
        time: "Ongoing",
        icon: BookOpen,
    ...
    () => [
      {
        ...
        description:
          "Overwhelming coursework, perfectionism, and fear of failure affecting your studies and mental health",
        symptoms:
          "Anxiety before exams, procrastination, feeling never good enough",
        icon: GraduationCap,
        accent: "blue",
      },
      {
        ...
        description:
          "Difficulty making connections, loneliness, and social anxiety in college environments",
        symptoms:
          "Feeling left out, fear of judgment, avoiding social situations",
        icon: Users,
        accent: "green",
      },
      {
        ...
        description:
          "Money worries, student loans, and working while studying creating additional pressure",
        symptoms:
          "Constant worry about money, sleep loss, avoiding activities due to cost",
        icon: DollarSign,
        accent: "orange",
      },
      {
        ...
        description:
          "Adjusting to independence, changing relationships, and uncertain future plans",
        symptoms:
          "Feeling overwhelmed by change, identity confusion, homesickness",
        icon: ArrowRightLeft,
        accent: "purple",
      },
    ],
    ...
    () => [
      {
        ...
        description:
          "Breaking down privacy concerns and social stigma around mental health",
        concerns: [
        ...
        testimonial:
          "I was terrified someone would find out, but the anonymous chat gave me the courage to eventually book counseling.",
      ...
      },
      {
        ...
        description:
          "Solving accessibility and availability barriers to mental health care",
        concerns: [
        ...
        testimonial:
          "Having AI support at 3 AM during finals week literally saved me from a complete breakdown.",
      ...
      },
      {
        ...
        description:
          "Providing clarity and guidance for mental health support navigation",
        concerns: [
        ...
        testimonial:
          "The assessment helped me realize that what I was feeling wasn't just 'normal stress' and I deserved support.",
    ...
    () => [
      {
        ...
        quote:
          "I went from having panic attacks before every class to confidently presenting my research. The AI chat taught me breathing techniques, and my counselor helped me understand my triggers. My GPA went from 2.1 to 3.8.",
        outcomes: [
      ...
      },
      {
        ...
        quote:
          "I felt completely alone and was planning to drop out. The peer support forum showed me I wasn't the only one struggling. My counselor helped me understand that depression isn't a personal failure. I'm now thriving in my major.",
        outcomes: [
      ...
      },
      {
        ...
        quote:
          "During my darkest moment, the crisis chat connected me to help immediately. The counselor met me within hours. Now I understand that asking for help was the strongest thing I could do. I graduate next month with honors.",
        outcomes: [
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Anonymous platform usage (AI chat, assessments, forums) creates no records. Campus counseling appointments may be noted in your student health records but are kept completely separate from academic records and cannot affect your grades or standing. Off-campus therapy is private between you and your provider. We're transparent about what gets documented where.",
    },
    {
  ...
  const platformFeatures = [
    {
      ...
      description:
        "Advanced conversational AI trained on evidence-based therapeutic techniques",
      capabilities: [
    ...
    },
    {
      ...
      description:
        "Licensed mental health professionals specializing in student populations",
      capabilities: [
    ...
    },
    {
      ...
      description:
        "Safe, moderated spaces for students to connect and share experiences",
      capabilities: [
    ...
    },
    {
      ...
      description:
        "Curated collection of mental health education and self-help materials",
      capabilities: [
  ...
  const securityFeatures = [
    {
      ...
      description:
        "Healthcare-grade security standards for all personal information",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete privacy protection for students concerned about confidentiality",
      features: [
    ...
    },
    {
      ...
      description:
        "Strict adherence to mental health professional ethical standards",
      features: [
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="min-h-screen bg-background text-foreground scroll-smooth">
        ...
        <ParallaxSection
          offset={shouldUseHeavyAnimations ? 80 : 0}
          className="hero-section relative overflow-hidden min-h-screen flex items-center scroll-mt-16"
        >
          <motion.section
            id="hero"
            ref={heroRef}
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-center">
                ...
                >
                  ...
                  >
                    ...
                    >
                      Break free from the barriers that prevent students from
                      accessing mental health support. Our evidence-based
                      platform combines AI-powered assistance, professional
                      counseling, and peer community support—all designed
                      specifically for the unique challenges of college life.
                    </motion.p>
                  </motion.div>
                  ...
                  >
                    {[
                      ...
                      <div
                        key={index}
                        className="trust-indicator group"
                  ...
                  <div className="hero-illustration p-8 floating">
                    ...
                    <div className="space-y-8 relative z-10">
                      ...
                      <div className="text-center">
                        ...
                        <h3
                          className="text-card-title text-high-contrast mb-3 font-semibold"
                          data-testid="text-wellness-title"
                        >
                          Supporting Student Wellness
                        </h3>
                        <p
                          className="text-body text-medium-contrast max-w-sm mx-auto"
                          data-testid="text-wellness-description"
                        >
                          Join thousands of students finding their path to
                          mental wellness
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        {[
                          ...
                          <div
                            key={index}
                            className="text-center p-4 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-white/70 dark:hover:bg-gray-800/70 transition-all duration-300 group"
                            data-testid={`hero-feature-${index}`}
                          >
                            <item.icon
                              className={`h-6 w-6 ${item.color} mx-auto mb-2 group-hover:scale-110 transition-transform`}
                            />
                            <span className="text-small text-medium-contrast font-medium">
                              {item.label}
                            </span>
                          </div>
                        ))}
                      ...
                      <div className="bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-white/20 dark:border-gray-700/30">
                        <div className="grid grid-cols-3 gap-4 text-center">
                          <div>
                            <div className="text-lg font-bold text-emphasis">
                              15K+
                            </div>
                            <div className="text-small text-medium-contrast">
                              Students
                            </div>
                          </div>
                          <div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2
                className="text-4xl md:text-5xl lg:text-6xl font-bold text-red-600 dark:text-red-400 mb-6 leading-tight"
                data-testid="text-crisis-title"
              >
                The Student Mental Health Crisis Demands Immediate Action
              </h2>
              <p
                className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed"
                data-testid="text-crisis-subtitle"
              >
                The numbers reveal an urgent need for accessible, comprehensive
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Every feature designed with student mental health expertise and
                  ...
                  <Card className="h-full p-8 bg-gradient-to-br from-card to-card/50 border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-2xl group">
                    <CardContent className="space-y-6">
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        >
                          <feature.icon
                            className={`h-8 w-8 text-${feature.accent}-500`}
                          />
                        </motion.div>
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          {feature.capabilities.map((capability, capIndex) => (
                            ...
                            >
                              <CheckCircle
                                className={`h-4 w-4 text-${feature.accent}-500 mt-0.5 flex-shrink-0`}
                              />
                      ...
                      >
                        ...
                        >
                          ...
                          <ArrowRight
                            className={`h-4 w-4 transition-transform group-hover:translate-x-1 text-${feature.accent}-500`}
                          />
                        </Button>
                      </motion.div>
                    </CardContent>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Healthcare-grade security standards with complete transparency
                ...
                >
                  <Card className="h-full p-6 bg-gradient-to-br from-card to-card/80 border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-xl group">
                    <CardContent className="space-y-6">
                      ...
                      >
                        <security.icon
                          className={`h-8 w-8 text-${security.color}-500`}
                        />
                      </motion.div>
                      ...
                      <ul className="space-y-2">
                        {security.features.map((feature, featureIndex) => (
                          ...
                          >
                            <CheckCircle
                              className={`h-3 w-3 text-${security.color}-500 mt-0.5 flex-shrink-0`}
                            />
                            <span className="text-muted-foreground">
                              {feature}
                            </span>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Data-driven evidence of how our platform transforms student
                      ...
                      >
                        <Card className="text-center p-8 bg-gradient-to-br from-card to-card/80 border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-xl group">
                          <CardContent className="space-y-6">
                            ...
                            >
                              <metric.icon
                                className={`h-8 w-8 text-${metric.color}-500`}
                              />
                            </motion.div>
        ...
        <section
          ...
          style={{ background: "var(--section-secondary)" }}
          data-testid="section-solution-promise"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2
                className="text-hero text-high-contrast mb-4"
              ...
              <div data-testid="traditional-barriers">
                ...
                <div className="space-y-4">
                  {traditionalBarriers.map((barrier, index) => (
                    <div
                      key={index}
                      className="flex items-start space-x-3 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg"
                      data-testid={`barrier-${index}`}
                    >
            ...
            <Card
              className="card-professional bg-primary/10 dark:bg-primary/5 border-primary/20 mb-16"
              data-testid="success-story-preview"
            >
              <CardContent className="p-8">
                <div className="text-center space-y-6">
                  ...
                  <blockquote
                    className="text-lead text-high-contrast italic"
                    data-testid="text-preview-quote"
                  >
                    "I went from having daily panic attacks to managing my
                    anxiety confidently. The 24/7 AI chat was there when I
                    needed it most at 2 AM, and it connected me to a counselor
                    who changed my life."
                  </blockquote>

                  <div className="space-y-2">
                    <p
                      className="text-card-subtitle text-emphasis"
                      data-testid="text-preview-author"
                    >
                      Sarah M., Junior Psychology Major
                    </p>
                    <p
                      className="text-body-large text-green-600 dark:text-green-400 font-semibold"
            ...
            >
              {[
                ...
                >
                  <div
                    className="text-stat-number text-emphasis mb-2"
                    data-testid={`impact-number-${index}`}
                  >
                    {metric.number}
                  </div>
                  <p
                    className="text-body text-low-contrast"
                    data-testid={`impact-text-${index}`}
                  >
                    {metric.text}
                  </p>
                </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p
                className="text-lead text-medium-contrast max-w-3xl mx-auto"
            ...
            <div className="relative" data-testid="journey-steps">
              ...
              <div
                className="hidden lg:block absolute top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-300 to-pink-300 dark:from-blue-600 dark:to-pink-600 z-0"
                ...
                {journeySteps.map((step, index) => (
                  ...
                  >
                    ...
                    {index < journeySteps.length - 1 && (
                      <div
                        className="lg:hidden absolute left-8 top-full w-0.5 h-8 bg-gradient-to-b from-current to-transparent opacity-30 z-0"
                        style={{
                          color: step.bgColor.includes("blue")
                            ? "#3B82F6"
                            : step.bgColor.includes("green")
                            ? "#10B981"
                            : step.bgColor.includes("purple")
                            ? "#8B5CF6"
                            : step.bgColor.includes("orange")
                            ? "#F59E0B"
                            : "#EC4899",
                        }}
                      ></div>
                    ...
                    <Card
                      className={`card-professional ${step.bgColor} border-none shadow-lg hover:shadow-xl transition-all duration-300 h-full`}
                    >
                      <CardContent className="p-6 text-center space-y-4 flex flex-col h-full">
                        ...
                        <h3
                          className="text-card-title text-high-contrast font-semibold"
                          data-testid={`journey-title-${index}`}
                        >
                          {step.title}
                        </h3>

                        <p
                          className="text-card-description text-medium-contrast flex-grow"
                          data-testid={`journey-description-${index}`}
                        >
                          {step.description}
                        </p>
                        ...
                        <div className="space-y-3">
                          <p
                            className="text-small text-emphasis font-semibold flex items-center justify-center gap-2"
                            data-testid={`journey-time-${index}`}
                          >
      ...
      */}
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              >
                Every feature designed specifically for student mental health
                challenges with
          ...
          */}
                  ...
                  <Card
                    ...
                    ${
                      tile.isEmergency
                        ...
                        : `bg-gradient-to-br ${
                            tile.gradient === "gradient-tile-blue-purple"
                              ? "from-blue-500/10 via-purple-500/10 to-blue-600/10"
                              : tile.gradient === "gradient-tile-green-teal"
                              ? "from-green-500/10 via-teal-500/10 to-green-600/10"
                              : tile.gradient === "gradient-tile-purple-pink"
                              ? "from-purple-500/10 via-pink-500/10 to-purple-600/10"
                              : tile.gradient === "gradient-tile-orange-yellow"
                              ? "from-orange-500/10 via-yellow-500/10 to-orange-600/10"
                              : tile.gradient === "gradient-tile-teal-blue"
                              ? "from-teal-500/10 via-blue-500/10 to-teal-600/10"
                          ...
                          <Link
                            ...
                            aria-label={
                              tile.isEmergency
                                ...
                                : `${
                                    tile.button
                                  } - Access ${tile.title.toLowerCase()} features`
                            }
            ...
            >
              <p className="text-sm md:text-base text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                💡 <span className="font-medium">Pro tip:</span> Start with our
                free assessment to get personalized recommendations, or jump
                directly into AI chat for immediate support. Every feature is
                designed to work together for comprehensive care.
              </p>
            </motion.div>
          </div>
        </motion.section>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2
                className="text-3xl md:text-4xl lg:text-5xl font-bold font-heading text-high-contrast mb-4"
                data-testid="text-challenges-title"
              >
                Student-Specific Mental Health Challenges
              </h2>
              <p
                className="text-xl text-medium-contrast max-w-3xl mx-auto"
                data-testid="text-challenges-subtitle"
              >
              ...
              {challengeCards.map((challenge, index) => (
                <Card
                  ...
                  className={`card-professional hover:shadow-xl transition-all duration-300 group border-l-4 ${
                    challenge.accent === "blue"
                      ? "border-l-blue-500 bg-blue-50/50 dark:bg-blue-950/20"
                      : challenge.accent === "green"
                ...
                >
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <CardTitle
                          className="text-xl font-bold text-high-contrast"
                          data-testid={`challenge-title-${index}`}
                        >
                          {challenge.title}
                        </CardTitle>
                      </div>
                  ...
                  <CardContent className="space-y-6">
                    <p
                      ...
                      data-testid={`challenge-description-${index}`}
                    >
                    ...
                    >
                      ...
                      <p
                        className="text-medium-contrast text-sm"
                        data-testid={`challenge-symptoms-${index}`}
                      >
                        {challenge.symptoms}
                      </p>
                    </div>
        ...
        <section
          className="py-16 lg:py-24 bg-gradient-to-b from-background via-muted/20 to-background"
          data-testid="section-breaking-barriers"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2
                className="text-3xl md:text-4xl lg:text-5xl font-bold font-heading text-high-contrast mb-4"
                data-testid="text-barriers-title"
              >
                Breaking Down Every Barrier to Mental Health Care
              </h2>
              <p
                className="text-xl text-medium-contrast max-w-3xl mx-auto"
                data-testid="text-barriers-subtitle"
              >
                Addressing the real obstacles that prevent students from
                ...
                return (
                  ...
                  >
                    <CardHeader className="text-center pb-6">
                      ...
                      <CardTitle
                        className="text-2xl font-bold text-high-contrast mb-4"
                        data-testid={`barrier-title-${index}`}
                      >
                        {barrier.title}
                      </CardTitle>
                      <p
                        className="text-medium-contrast mb-6"
                        data-testid={`barrier-description-${index}`}
                      >
                        {barrier.description}
                      </p>
                    </CardHeader>
                    <CardContent className="space-y-8">
                        ...
                        <ul className="space-y-2">
                          {barrier.concerns.map((concern, concernIndex) => (
                            <li
                              ...
                              data-testid={`concern-${index}-${concernIndex}`}
                            >
                        ...
                        <ul className="space-y-2">
                          {barrier.solutions.map((solution, solutionIndex) => (
                            <li
                              key={solutionIndex}
                              className="flex items-start space-x-3"
                              data-testid={`solution-${index}-${solutionIndex}`}
                            >
                      ...
                      <div className="bg-gradient-to-r from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10 rounded-xl p-4 border border-primary/20 dark:border-primary/30">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <p
                              className="text-sm text-medium-contrast italic mb-2"
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Carousel
              ...
              data-testid="success-stories-carousel"
              role="region"
                      ...
                      <CardContent className="p-12 text-center space-y-8">
                        <div className="space-y-4">
                          <p
                            ...
                            data-testid={`story-type-${index}`}
                          >
                            {story.studentType}
                          </p>
                          <p
                            className="text-lg text-low-contrast"
                            data-testid={`story-challenge-${index}`}
                          >
                            Challenge: {story.challenge}
                          </p>
                          <p
                            className="text-sm text-low-contrast"
                            data-testid={`story-timeline-${index}`}
                          >
                        ...
                        <blockquote
                          className="text-xl md:text-2xl font-medium text-high-contrast italic leading-relaxed"
                          data-testid={`story-quote-${index}`}
                        >
                          "{story.quote}"
                        </blockquote>
                          ...
                          <ul className="space-y-2">
                            {story.outcomes.map((outcome, outcomeIndex) => (
                              <li
                                ...
                                data-testid={`story-outcome-${index}-${outcomeIndex}`}
                              >
        ...
        <section
          className="py-16 lg:py-24"
          style={{ background: "var(--section-secondary)" }}
          data-testid="section-evidence-based"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={index}
                      className="flex items-start space-x-3"
                      data-testid={`research-point-${index}`}
                    >
              ...
              <div className="space-y-6" data-testid="platform-statistics">
                ...
                <div className="space-y-6">
                  {[
                    {
                      stat: "94%",
                      desc: "of users report symptom improvement",
                    },
                    ...
                    >
                      <div
                        ...
                        data-testid={`platform-number-${index}`}
                      >
                        {item.stat}
                      </div>
                      <p
                        className="text-low-contrast"
                        data-testid={`platform-desc-${index}`}
                      >
                        {item.desc}
                      </p>
                    </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                      <li data-testid="team-psychologists">
                        • Licensed clinical psychologists
                      </li>
                      <li data-testid="team-counselors">
                        • Campus counseling professionals
                      </li>
                      <li data-testid="team-crisis">
                        • Crisis intervention specialists
                      </li>
                      <li data-testid="team-cultural">
                    ...
                    <ul className="space-y-2">
                      {[
                        ...
                        <li
                          ...
                          data-testid={`quality-process-${index}`}
                        >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {faqData.map((faq, index) => (
                ...
                >
                  <AccordionTrigger
                    className="text-left font-semibold text-high-contrast hover:text-primary"
        ...
        <section
          className="py-16 lg:py-24 bg-primary dark:bg-primary/90"
          data-testid="section-take-action"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2
              ...
              <p
                ...
                data-testid="text-action-subtitle"
              >
                Every option is confidential, secure, and designed with your
                complete privacy in mind
              </p>
            </div>
            ...
            >
              {actionOptions.map((option, index) => (
                <Card
                  key={index}
                  className="card-professional bg-white dark:bg-gray-800 border-none shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
                  data-testid={`action-option-${index}`}
                >
                  <CardContent className="p-8 text-center space-y-6">
                    ...
                    <div className="space-y-3">
                      <h3
                        className="text-lg font-bold text-high-contrast"
                        data-testid={`action-title-${index}`}
                      >
                        {option.title}
                      </h3>
                      <p
                        className="text-medium-contrast"
                        data-testid={`action-description-${index}`}
                      >
                        {option.description}
                      </p>
                      <p
                        className="text-sm font-semibold text-primary"
                        data-testid={`action-time-${index}`}
                      >
                        {option.time}
                      </p>
                    </div>
